...
public:
    ...
    void paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const override
    {
      if (option.state & QStyle::State_Selected) {
        ...
        QRect fill_rect(option.rect.x(), option.rect.y(), option.rect.width(),
                        option.rect.height());
        ...
        //头像显示区域
        QRect iconRect = QRect(option.rect.x() + 20,
                               option.rect.y() + 10,
                               30, 30);
        ...
        // 
        QRect titleRect = QRect(option.rect.x() + 30 + 30,
                                option.rect.y(),
                                100, 50);
...
MeetingManager::MeetingManager(QWidget *parent)
    : QWidget(parent)
{
    ui.setupUi(this);
    addMeetingType();
...
void MeetingManager::addMeetingType()
{
  ...
  auto *allHistory = new QStandardItem(QIcon("Resources/history.png"), tr("我的会议"));
  allHistory->setData(QString("Resources/history.png"), MeetingIconRole);

  auto *voice = new QStandardItem(QIcon("Resources/voice.png"), tr("语音会议"));
  voice->setData(QString("Resources/voice.png"), MeetingIconRole);

  auto *video = new QStandardItem(QIcon("Resources/video.png"), tr("视频会议"));
